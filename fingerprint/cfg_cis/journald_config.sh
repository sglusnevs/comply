...
echo_log 'INFO' 'Gathering journald configs...'

CFG_FILE='/etc/systemd/journald.conf'

ls $CFG_FILE | while read FILENAME; do 

cat <<-EOS1
    <ConfigData complysh:module="$MODNAME" Label="journald Config" Location="$FILENAME" Type="WININI">
EOS1
